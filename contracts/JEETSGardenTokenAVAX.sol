...
contract JEETSGardenTokenAVAX is ERC20, Ownable {
    ...
    constructor(
        ...
        pairAddress = IJoeFactory(_unifactory).createPair(address(this), _weth);
    }
